...
class ImageUploader:
    def __init__(self):
        ...
        self.api_key = "6d207e02198a847aa98d0a2a901485a5"  # Публичный ключ FreeImage.host
    ...
    def upload_image(self, image_data: bytes) -> str:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logging.info(f"FreeImage response: {result}")
                ...
                if result.get('success'):
                    ...
                    logging.error(f"FreeImage API error: {error_msg}")
                    return None
            ...
            logging.error("FreeImage upload timeout")
            return None
        except requests.exceptions.ConnectionError:
            logging.error("FreeImage connection error")
            return None
...
❌ Не удалось отправить: {total_users - successful_sends}
    ...
    async def handle_photo(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            # Скачиваем изображение (среднее качество для скорости)
